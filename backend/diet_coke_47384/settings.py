"""
Django settings for diet_coke_47384 project.
...
ROOT_URLCONF = 'diet_coke_47384.urls'
...
WSGI_APPLICATION = 'diet_coke_47384.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "diet_coke_47384 API",
    "DESCRIPTION": "API documentation for diet_coke_47384 App",
    "VERSION": "v1",
}
